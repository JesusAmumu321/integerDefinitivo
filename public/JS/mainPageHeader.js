/******/ (() => {
  ...
  (() => {
    ...
    var collapse = __webpack_require__(745); // CONCATENATED MODULE: ./node_modules/@popperjs/core/lib/dom-utils/getBoundingClientRect.js
    ...
    var round = Math.round; // CONCATENATED MODULE: ./node_modules/@popperjs/core/lib/modifiers/computeStyles.js
    // eslint-disable-next-line import/no-unused-modules
      ...
      if (checkMainAxis || checkAltAxis) {
        ...
        if (checkAltAxis) {
          ...
          var _preventedOffset = within(
            tether ? math_min(_min, tetherMin) : _min,
            _offset,
            tether ? math_max(_max, tetherMax) : _max
          );
    ...
    }); // eslint-disable-next-line import/no-unused-modules // CONCATENATED MODULE: ./src/components/dropdown.js
    ...
    var modal = __webpack_require__(508); // CONCATENATED MODULE: ./src/components/tooltip.js
    // Toggle dropdown elements using [data-dropdown-toggle]
